        ...
        <div className="w-full max-w-md p-8">
          <Tabs value={tab} onValueChange={(value) => setTab(value as "login" | "register")}>
            <TabsList className="grid w-full grid-cols-2 bg-zinc-800">
              <TabsTrigger value="login" className="data-[state=active]:bg-primary data-[state=active]:text-black">Prisijungti</TabsTrigger>
              <TabsTrigger value="register" className="data-[state=active]:bg-primary data-[state=active]:text-black">Registruotis</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="register">
              <Card className="bg-zinc-900 border-zinc-800 text-white">
                <CardHeader>
                  <CardTitle className="text-white">Sukurti paskyrą</CardTitle>
                  <CardDescription className="text-white/70">Įveskite duomenis, kad sukurtumėte DJ paskyrą</CardDescription>
                </CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        type="password"
                        className="bg-zinc-800 border-zinc-700 text-white focus:border-primary"
                        {...registerForm.register("confirmPassword", { required: "Pakartokite slaptažodį" })}
                      />
